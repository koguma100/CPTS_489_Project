class LoggedInNavbarComponent extends HTMLElement {
  connectedCallback() {
    this.innerHTML = `
    <header class="bg-midnight-violet shadow-lg">
        <div class="px-6 py-3 flex items-center justify-between">
            ...
            <div class="flex items-center gap-4">
                ...
                <a href="login.html" 
                class="flex items-center justify-center gap-2 w-28 py-2 text-sm rounded-xl
                        text-white font-semibold bg-gradient-to-r from-red-600 to-red-400
                        shadow ring-1 ring-white/15 hover:brightness-110 transition">
                    Sign out
                </a>
            </div>
...
customElements.define("logged-in-navbar", LoggedInNavbarComponent);