...
export class GameModel {
  ...
  async broadcastQuestion(channel, { questionIndex, text, options, isMultiple, correctAnswer, timeLimitMs, thumbnail }) {
    await channel.send({
      type:    'broadcast',
      event:   'QUESTION_START',
      payload: { questionIndex, text, options, isMultiple, correctAnswer, timeLimitMs, startedAt: Date.now(), thumbnail },
    })
  }
